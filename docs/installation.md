...
!!! tip
    There are many tests available in the Yatta [repository](https://github.com/yatta-lang/yatta/tree/master/language/tests) that can serve as a good starting point for writing some programs in Yatta.
